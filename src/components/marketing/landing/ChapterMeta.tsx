    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 max-sm:px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-md:gap-6 items-center">
          {/* Animated funnel */}
          <Reveal>
            <div className="relative h-[420px] max-sm:h-[280px] flex flex-col items-center justify-between">
              {[
                {
                ...
                <motion.div
                  ...
                  className="w-full flex items-center gap-4 max-sm:gap-2.5 px-5 max-sm:px-3 py-4 max-sm:py-2.5 rounded-xl"
                  style={{
                ...
                >
                  <div
                    className="w-9 h-9 max-sm:w-6 max-sm:h-6 rounded-lg flex-shrink-0"
                    style={{
                  ...
                  <div className="flex-1">
                    <div
                      className="text-sm max-sm:text-[12px] font-medium"
                      style={{ color: "rgba(255,255,255,0.9)" }}
                    >
                      {step.label}
                    </div>
                    <div
                      className="text-[11px] max-sm:text-[10px] uppercase tracking-wider mt-1 max-sm:mt-0.5"
